        ...
        function validateField(field) {
            ...
            if (field.type === 'email' && value) {
                ...
                if (!emailRegex.test(value)) {
                    showError(field, isRTL ? 'يرجى إدخال بريد إلكتروني صحيح' : 'Please enter a valid email');
                    return false;
                }
            }
            ...
            if (field.type === 'tel' && value) {
                ...
                if (!phoneRegex.test(value)) {
                    showError(field, isRTL ? 'يرجى إدخال رقم هاتف صحيح' : 'Please enter a valid phone number');
                    return false;
                }
            }
            ...
            if (field.hasAttribute('minlength') && value) {
                ...
                if (value.length < minLength) {
                    showError(field, (isRTL ? 'يجب أن يكون على الأقل ' : 'Must be at least ') + minLength + (isRTL ? ' أحرف' : ' characters'));
                    return false;
                }
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    submitBtn.textContent = document.dir === 'rtl' ? 'جارٍ الإرسال...' : 'Sending...';
                    ...
                    setTimeout(function() {
                        ...
                        successMsg.textContent = document.dir === 'rtl' ? 'تم الإرسال بنجاح!' : 'Message sent successfully!';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '013908b2-1a94-4058-918c-515e81fcb1c7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '013908b2-1a94-4058-918c-515e81fcb1c7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '013908b2-1a94-4058-918c-515e81fcb1c7';
